BASE.require([
    ...
    app.entities.LeftHorizontalHedge = function () {
        app.Entity.call(this);

        this["@class"] = "app.entities.LeftHorizontalHedge";
        this.type = "left-horizontal-hedge";

        var image = new app.properties.ImageTexture();
        image.path = "/images/props.png";
        image.position.x = 412;
    ...
    BASE.extend(app.entities.LeftHorizontalHedge, app.Entity);
