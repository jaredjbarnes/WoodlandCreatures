BASE.require([
    ...
    app.entities.BottomLeftHedge = function () {
        app.Entity.call(this);

        this["@class"] = "app.entities.BottomLeftHedge";
        this.type = "bottom-left-hedge";
    ...
    BASE.extend(app.entities.BottomLeftHedge, app.Entity);
