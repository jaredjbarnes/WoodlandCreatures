BASE.require([
    ...
    app.entities.VerticalBottomHedge = function () {
        app.Entity.call(this);

        this["@class"] = "app.entities.VerticalBottomHedge";
        this.type = "vertical-bottom-hedge";
    ...
    BASE.extend(app.entities.VerticalBottomHedge, app.Entity);
