BASE.require([
    ...
    app.entities.TopRightHedge = function () {
        app.Entity.call(this);

        this["@class"] = "app.entities.TopRightHedge";
        this.type = "top-right-hedge";

        var image = new app.properties.ImageTexture();
        image.path = "/images/props.png";
        image.position.x = 446;
    ...
    BASE.extend(app.entities.TopRightHedge, app.Entity);
