BASE.require([
    ...
    app.entities.HorizontalHedge = function () {
        app.Entity.call(this);

        this["@class"] = "app.entities.HorizontalHedge";
        this.type = "horizontal-hedge";

        var image = new app.properties.ImageTexture();
        image.path = "/images/props.png";
        image.position.x = 367;
    ...
    BASE.extend(app.entities.HorizontalHedge, app.Entity);
