BASE.require([
    ...
    app.entities.VerticalHedge = function () {
        app.Entity.call(this);

        this["@class"] = "app.entities.VerticalHedge";
        this.type = "vertical-hedge";

        var image = new app.properties.ImageTexture();
        image.path = "/images/props.png";
        image.position.x = 350;
        image.position.y = 315;
        image.size.width = 16;
    ...
    BASE.extend(app.entities.VerticalHedge, app.Entity);
